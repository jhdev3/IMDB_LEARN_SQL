--Hur databasen Initerades vilka Index som skapades och så
--Query hämtad från https://www.sqlshack.com/gathering-sql-server-indexes-statistics-and-usage-information/
